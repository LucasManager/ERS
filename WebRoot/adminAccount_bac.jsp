...
<td valign="top" width="65%">
	...
	<tr>
		...
		<html:form action="/adminAccount" focus="firstname" styleClass="SetForm">
			...
			<html:submit onclick="if(!smtCfm(setAccountForm)){return false;}" styleClass="button"><fmt:message key="button.submit.displayname"/></html:submit>  <html:cancel styleClass="button"><fmt:message key="button.cancel.displayname"/></html:cancel>
		</html:form>
		</td>
	</tr>
	</table>
